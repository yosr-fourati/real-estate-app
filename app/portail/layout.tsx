...
const navItems = [
  { href: "/portail", label: "Tableau de bord", icon: BarChart3 },
  { href: "/portail/properties", label: "Propriétés", icon: Building2 },
  { href: "/portail/leads", label: "Contacts", icon: Users },
];
...
function AdminGuard({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    if (status === "unauthenticated" && pathname !== "/portail/login") {
