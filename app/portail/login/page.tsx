        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="space-y-2">
            <Label htmlFor="captcha">
              Vérification : {captcha.a} + {captcha.b} = ?
            </Label>
            <div className="flex gap-2">
              ...
              <button
                ...
                className="p-2 text-gray-400 hover:text-brand-500 border border-gray-200 rounded-lg transition-colors"
            ...
            {captchaError && (
              <p className="text-red-500 text-xs">Réponse incorrecte, essayez à nouveau.</p>
            )}
          </div>
